...
import { ChevronRight, PlayCircle, Database } from "lucide-react";

const practicals = [
    { id: 1, title: "DBMS Environment and Basic Operations", difficulty: "Easy" },
    { id: 2, title: "Database Application Development (Store/Vendor/Finance)", difficulty: "Medium" },
    { id: 3, title: "SQL Queries and Database Operations", difficulty: "Hard" },
    { id: 4, title: "Normalization and Dependency Analysis", difficulty: "Hard" },
    { id: 5, title: "Host Language Interface with Database", difficulty: "Medium" }
];
