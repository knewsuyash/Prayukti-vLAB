...
const practicalData = {
    1: {
      ...
      <ul class="list-disc ml-6 mt-2 space-y-1">
        ...
        <li><strong>OR Gate:</strong> Output is high if at least one one input is high.</li>
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col">
            <header className="bg-white border-b shadow-sm sticky top-0 z-10">
                <div className="container mx-auto px-4 py-4 flex items-center gap-4">
                    <Link href="/student/dashboard/dld" className="text-gray-500 hover:text-black hover:bg-gray-100 p-1 rounded-full">
            ...
            <main className="container mx-auto px-4 py-8 flex-1 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                    <div className="bg-white p-6 rounded-lg shadow-md border border-orange-200">
                        ...
                        <Link href={`/student/dashboard/dld/${id}/simulation`}>
